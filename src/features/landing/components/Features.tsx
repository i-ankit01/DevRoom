...
const features = [
  {
    title: "Instant Setup",
    description: "No installation needed. Start coding immediately in your browser with zero configuration.",
    icon: <IconTerminal2 />,
  },
  {
    title: "Realtime Collaboration",
    description: "Share your workspace, pair program, and review code together with your team in real-time.",
    icon: <IconUsers />,
  },
  {
    title: "One-Click Deploy",
    description: "Deploy your applications instantly with a single click. No complex DevOps required.",
    icon: <IconRocket />,
  },
  {
    title: "Secure by Default",
    description: "Enterprise-grade security with encrypted connections and isolated environments.",
    icon: <IconLock />,
  },
  {
    title: "Access Anywhere",
    description: "Code from any device, anywhere. Your workspace follows you wherever you go.",
    icon: <IconWorld />,
  },
  {
    title: "Full Terminal Access",
    description: "Complete command-line access with pre-installed tools and custom environment support.",
    icon: <IconCode />,
  },
];
